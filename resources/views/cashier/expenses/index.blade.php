...
@push('stylesDashboard')
    ...
    <style>
        ...
        .expenses-theme .stats-card {
            background: linear-gradient(135deg, #0D47A1, #1976D2);
            border: 1px solid rgba(25,118,210,0.13);
            box-shadow: 0 4px 28px rgba(13,71,161,0.09);
            border-radius: 16px;
        }
        .expenses-theme .stats-label { opacity: .9; }

        .expenses-theme .table-custom thead {
            background: linear-gradient(135deg, #0D47A1, #1976D2);
            color: #fff;
        }
        .expenses-theme .table-custom tbody tr:hover {
            background: #f4f9ff;
            transform: none;
        }
