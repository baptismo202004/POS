...
<script src="https://cdn.jsdelivr.net/npm/tesseract.js@4/dist/tesseract.min.js"></script>
        ...
        <main class="flex-fill p-4">
            <div class="container-fluid">
                <div class="row mb-6">
                    <div class="col-12">
                        <div class="p-4 card-rounded shadow-sm bg-white">
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                ...
                                <div>
                                    <a href="<?php echo e(route('superadmin.purchases.index')); ?>" class="btn btn-outline-primary">
                                        Back to Purchases
                                    </a>
                    ...
                    <form method="POST" action="<?php echo e(route('superadmin.purchases.store')); ?>">
                        <?php echo csrf_field(); ?>
            ...
            <div class="row g-3 align-items-end">
                ...
                <div class="col-md-2">
                    ...
                    <select name="items[][unit_type_id]" class="form-select" required>
                        ...
                        <?php $__currentLoopData = $unit_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="addSupplierForm" action="<?php echo e(route('suppliers.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="mb-3">
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        $('#saveProductBtn').on('click', function () {
            ...
            $.ajax({
                url: '<?php echo e(route("superadmin.products.store")); ?>',
                method: 'POST',
                data: form.serialize(),
                headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') },
                success: function (response) {
                ...
                Tesseract.recognize(file, 'eng', { logger: m => console.log(`File ${index + 1}:`, m) })
                    .then(({ data: { text } }) => {
                        ...
                        if (processedCount === files.length) {
                            ...
                            $.ajax({
                                url: '<?php echo e(route("superadmin.purchases.ocr-product-match")); ?>',
                                method: 'POST',
                                data: { _token: '<?php echo e(csrf_token()); ?>', text: combinedText },
                                success: function(response) {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\POS\resources\views/SuperAdmin/purchases/create.blade.php ENDPATH**/ ?>