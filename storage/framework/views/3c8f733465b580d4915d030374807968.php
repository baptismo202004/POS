        ...
        <div class="col-12">
            <div class="p-4 card-rounded shadow-sm bg-white">
                <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
                    ...
                    <a href="<?php echo e(route('admin.stockin.create')); ?>" class="btn" style="background-color:var(--theme-color); color:white">Add Stock In</a>
                </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-hover">
                                    <thead>
                                        <tr>
                                            <th><a href="<?php echo e(route('admin.stockin.index', ['sort' => 'product', 'direction' => request('direction') == 'asc' ? 'desc' : 'asc'])); ?>">Product</a></th>
                                            <th>Purchase Ref</th>
                                            <th>Quantity</th>
                                            <th>Price</th>
                                            <th>Date</th>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\POS\resources\views/Admin/stockin/index.blade.php ENDPATH**/ ?>