...
<div class="container-fluid">
    <div class="p-4 card-rounded shadow-sm bg-white">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="<?php echo e(route('admin.credits.index')); ?>" class="btn btn-outline-primary">Back to Credits</a>
        </div>
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <select class="form-select" name="branch_id" id="branch_id" required>
                                ...
                                <?php if($userBranch): ?>
                                    <option value="<?php echo e($userBranch->id); ?>" selected><?php echo e($userBranch->branch_name); ?></option>
                                <?php endif; ?>
                                <?php $__currentLoopData = \App\Models\Branch::where('status', 'active')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $branch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if(!$userBranch || $branch->id != $userBranch->id): ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select" name="customer_id" id="customer_id" required>
                                ...
                                <?php if($allCustomers->isNotEmpty()): ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\POS\resources\views/Admin/credits/create.blade.php ENDPATH**/ ?>