<aside class="sidebar shadow-sm p-4 d-flex flex-column justify-content-between" id="sidebar">
    ...
    <div class="grow" style="overflow-y: auto; overflow-x: hidden;">
        <nav class="d-flex flex-column gap-1" style="width: 100%; overflow: hidden;">
            ...
            ?>
            <a href="<?php echo e($dashboardRoute); ?>" class="<?php echo e($dashboardActive ? 'd-flex align-items-center rounded-lg text-decoration-none active' : 'd-flex align-items-center rounded-lg text-decoration-none'); ?>">
            ...
            <?php if (\Illuminate\Support\Facades\Blade::check('canAccess', 'products','view')): ?>
            <?php
                $isProductsActive = request()->routeIs('superadmin.products.*') || request()->routeIs('superadmin.categories.*');
            ?>
            <a class="d-flex align-items-center rounded-lg text-decoration-none <?php echo e($isProductsActive ? 'active' : ''); ?>" href="#" onclick="toggleSubmenu('productsMenu', event); return false;">
                <span class="bg-transparent rounded d-flex align-items-center justify-content-center icon-badge">
                    <svg class="icon sidebar-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="submenu <?php echo e($isProductsActive ? 'show' : ''); ?>" id="productsMenu">
                <div class="d-flex flex-column ms-4 mt-1">
                    <a href="<?php echo e(route('superadmin.products.index')); ?>" class="<?php echo e(request()->routeIs('superadmin.products.*') ? 'd-flex gap-2 align-items-center py-2 text-decoration-none active' : 'd-flex gap-2 align-items-center py-2 text-decoration-none'); ?>">
                        <span class="small">All Products</span>
                    </a>
                    <a href="<?php echo e(route('superadmin.categories.index')); ?>" class="<?php echo e(request()->routeIs('superadmin.categories.*') ? 'd-flex gap-2 align-items-center py-2 text-decoration-none active' : 'd-flex gap-2 align-items-center py-2 text-decoration-none'); ?>">
            ...
            <?php if (\Illuminate\Support\Facades\Blade::check('canAccess', 'purchases','view')): ?>
            <a href="<?php echo e(route('superadmin.purchases.index')); ?>" class="<?php echo e(request()->routeIs('superadmin.purchases.*') ? 'd-flex align-items-center rounded-lg text-decoration-none active' : 'd-flex align-items-center rounded-lg text-decoration-none'); ?>">
                <span class="bg-transparent rounded d-flex align-items-center justify-content-center icon-badge">
                    <svg class="icon sidebar-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="submenu <?php echo e($isInventoryActive ? 'show' : ''); ?>" id="inventoryMenu">
                <div class="d-flex flex-column ms-4 mt-1">
                    <a href="<?php echo e(route('superadmin.inventory.index')); ?>" class="<?php echo e(request()->routeIs('superadmin.inventory.index') ? 'd-flex gap-2 align-items-center py-2 text-decoration-none active' : 'd-flex gap-2 align-items-center py-2 text-decoration-none'); ?>">
                        <span class="small">Report</span>
                    </a>
                    <a href="<?php echo e(route('superadmin.inventory.out-of-stock')); ?>" class="<?php echo e(request()->routeIs('superadmin.inventory.out-of-stock') ? 'd-flex gap-2 align-items-center py-2 text-decoration-none active' : 'd-flex gap-2 align-items-center py-2 text-decoration-none'); ?>">
                        <span class="small">Out of Stock Alert (<?php echo e(session('out_of_stock_count', 0)); ?>/<?php echo e(session('out_of_stock_total', 0)); ?>)</span>
                    </a>
            ...
            <?php if (\Illuminate\Support\Facades\Blade::check('canAccess', 'sales','view')): ?>
            <?php
                $isSalesActive = request()->routeIs('superadmin.admin.sales.*');
            ?>
            <a class="d-flex align-items-center rounded-lg text-decoration-none <?php echo e($isSalesActive ? 'active' : ''); ?>" href="#" onclick="toggleSubmenu('salesMenu', event); return false;">
                <span class="bg-transparent rounded d-flex align-items-center justify-content-center icon-badge">
                    <svg class="icon sidebar-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="submenu <?php echo e($isSalesActive ? 'show' : ''); ?>" id="salesMenu">
                <div class="d-flex flex-column ms-4 mt-1">
                    <a href="<?php echo e(route('admin.sales.management.index')); ?>" class="<?php echo e(request()->routeIs('admin.sales.management.*') ? 'd-flex gap-2 align-items-center py-2 text-decoration-none active' : 'd-flex gap-2 align-items-center py-2 text-decoration-none'); ?>">
                        <span class="small">Sales</span>
                    </a>
                    <a href="<?php echo e(route('superadmin.sales.voided')); ?>" class="<?php echo e(request()->routeIs('superadmin.sales.voided') ? 'd-flex gap-2 align-items-center py-2 text-decoration-none active' : 'd-flex gap-2 align-items-center py-2 text-decoration-none'); ?>">
                        <span class="small">Voided Sales</span>
                    </a>
                    <a href="<?php echo e(route('admin.refunds.index')); ?>" class="<?php echo e(request()->routeIs('admin.refunds.*') ? 'd-flex gap-2 align-items-center py-2 text-decoration-none active' : 'd-flex gap-2 align-items-center py-2 text-decoration-none'); ?>">
                        <span class="small">Refund/Return</span>
                    </a>
                    <a href="<?php echo e(route('admin.credits.index')); ?>" class="<?php echo e(request()->routeIs('admin.credits.*') ? 'd-flex gap-2 align-items-center py-2 text-decoration-none active' : 'd-flex gap-2 align-items-center py-2 text-decoration-none'); ?>">
            ...
            <a href="<?php echo e(route('admin.expenses.index')); ?>" class="<?php echo e(request()->routeIs('admin.expenses.*') ? 'd-flex align-items-center rounded-lg text-decoration-none active' : 'd-flex align-items-center rounded-lg text-decoration-none'); ?>">
                <span class="bg-transparent rounded d-flex align-items-center justify-content-center icon-badge">
                    <svg class="icon sidebar-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="<?php echo e(route('suppliers.index')); ?>" class="<?php echo e(request()->routeIs('suppliers.*') ? 'd-flex align-items-center rounded-lg text-decoration-none active' : 'd-flex align-items-center rounded-lg text-decoration-none'); ?>">
                <span class="bg-transparent rounded d-flex align-items-center justify-content-center icon-badge">
                    <svg class="icon sidebar-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"></path>
                    </svg>
            ...
            <?php $isCustomerActive = false; ?>
            <a class="d-flex align-items-center rounded-lg text-decoration-none <?php echo e($isCustomerActive ? 'active' : ''); ?>" href="#" onclick="toggleSubmenu('customerMenu', event); return false;">
                <span class="bg-transparent rounded d-flex align-items-center justify-content-center icon-badge">
                    <svg class="icon sidebar-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="submenu <?php echo e($isCustomerActive ? 'show' : ''); ?>" id="customerMenu">
                <div class="d-flex flex-column ms-4 mt-1">
                    <a href="<?php echo e(route('admin.customers.index')); ?>" class="d-flex gap-2 align-items-center py-2 text-decoration-none"><span class="small">Customers</span></a>
                    <a href="<?php echo e(route('admin.customers.payment-history')); ?>" class="d-flex gap-2 align-items-center py-2 text-decoration-none"><span class="small">Payment History</span></a>
                </div>
            </div>

            <div class="section-label">ANALYTICS</div>
            
            <a href="<?php echo e(route('admin.reports.index')); ?>" class="<?php echo e(request()->routeIs('admin.reports.*') ? 'd-flex align-items-center rounded-lg text-decoration-none active' : 'd-flex align-items-center rounded-lg text-decoration-none'); ?>">
                <span class="bg-transparent rounded d-flex align-items-center justify-content-center icon-badge">
                    <svg class="icon sidebar-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <?php if (\Illuminate\Support\Facades\Blade::check('canAccess', 'user_management','view')): ?>
            <?php
                $isUserMgmtActive = request()->routeIs('users.*') || request()->routeIs('admin.access.*');
            ?>
            <a class="d-flex align-items-center rounded-lg text-decoration-none <?php echo e($isUserMgmtActive ? 'active' : ''); ?>" href="#" onclick="toggleSubmenu('userMgmtMenu', event); return false;">
                <span class="bg-transparent rounded d-flex align-items-center justify-content-center icon-badge">
                    <svg class="icon sidebar-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="submenu <?php echo e($isUserMgmtActive ? 'show' : ''); ?>" id="userMgmtMenu">
                <div class="d-flex flex-column ms-4 mt-1">
                    <a href="<?php echo e(route('admin.access.index')); ?>" class="<?php echo e(request()->routeIs('admin.access.*') ? 'd-flex gap-2 align-items-center py-2 text-decoration-none active' : 'd-flex gap-2 align-items-center py-2 text-decoration-none'); ?>">
                        <span class="small">Access Permission</span>
                    </a>
                    <a href="<?php echo e(route('admin.users.create')); ?>" class="<?php echo e(request()->routeIs('superadmin.admin.users.*') ? 'd-flex gap-2 align-items-center py-2 text-decoration-none active' : 'd-flex gap-2 align-items-center py-2 text-decoration-none'); ?>">
                        <span class="small">Create Account</span>
                    </a>
                    <a href="<?php echo e(route('admin.access.logs')); ?>" class="<?php echo e(request()->routeIs('superadmin.admin.access.logs') ? 'd-flex gap-2 align-items-center py-2 text-decoration-none active' : 'd-flex gap-2 align-items-center py-2 text-decoration-none'); ?>">
            ...
            <div>
                ...
                ?>
                <a class="d-flex align-items-center rounded-lg text-decoration-none <?php echo e($isSettingsActive ? 'active' : ''); ?>" href="#" onclick="toggleSubmenu('settingsMenu', event); return false;" id="settingsToggle">
                ...
                <div class="submenu <?php echo e($isSettingsActive ? 'show' : ''); ?>" id="settingsMenu">
                    <div class="d-flex flex-column ms-4 mt-1">
                        <a href="<?php echo e(route('brands.index')); ?>" class="<?php echo e(request()->routeIs('brands.*') ? 'd-flex align-items-center py-2 text-decoration-none active' : 'd-flex align-items-center py-2 text-decoration-none'); ?>">
                            <span class="small">Brands</span>
                        </a>
                        <a href="<?php echo e(route('branches.index')); ?>" class="<?php echo e(request()->routeIs('branches.*') ? 'd-flex align-items-center py-2 text-decoration-none active' : 'd-flex align-items-center py-2 text-decoration-none'); ?>">
                            <span class="small">Branch</span>
                        </a>
                        <a href="<?php echo e(route('unit-types.index')); ?>" class="<?php echo e(request()->routeIs('unit-types.*') ? 'd-flex align-items-center py-2 text-decoration-none active' : 'd-flex align-items-center py-2 text-decoration-none'); ?>">
    ...
    <div class="dropdown">
        <button class="d-flex align-items-center gap-2 w-100 text-start p-2" type="button" id="sidebarUserDropdown" data-bs-toggle="dropdown" aria-expanded="false" style="background: transparent; border: none; color: rgba(255, 255, 255, 0.9);">
            <?php if(!empty($sidebarAvatarUrl)): ?>
                <img src="<?php echo e($sidebarAvatarUrl); ?>" alt="<?php echo e($sidebarUser->name ?? 'User'); ?>" class="rounded-circle" style="width:32px;height:32px;object-fit:cover">
            <?php else: ?>
                <div class="rounded-circle d-flex align-items-center justify-content-center" style="width:32px;height:32px;background:linear-gradient(135deg, #2196F3, #00E5FF);color:#0D47A1;font-weight:700"><?php echo e($sidebarUser ? strtoupper(substr($sidebarUser->name,0,1)) : 'U'); ?></div>
            <?php endif; ?>
            <div class="ms-2 text-start">
                <div class="fw-semibold username"><?php echo e($sidebarUser->name ?? 'User'); ?></div>
            </div>
        </button>
        ...
        <ul class="dropdown-menu user-dropdown-menu" aria-labelledby="sidebarUserDropdown">
            <li class="px-3 py-2">
                <div class="d-flex align-items-center gap-2">
                    <?php if(!empty($sidebarAvatarUrl)): ?>
                        <img src="<?php echo e($sidebarAvatarUrl); ?>" alt="<?php echo e($sidebarUser->name ?? 'User'); ?>" class="rounded-circle" style="width:40px;height:40px;object-fit:cover">
                    <?php else: ?>
                        <div class="rounded-circle d-flex align-items-center justify-content-center" style="width:40px;height:40px;background:linear-gradient(135deg, #2196F3, #00E5FF);color:#0D47A1;font-weight:700"><?php echo e($sidebarUser ? strtoupper(substr($sidebarUser->name,0,1)) : 'U'); ?></div>
                    <?php endif; ?>
                    <div class="ms-2">
                        <div class="small text-muted"><?php echo e($sidebarUser->userType->name ?? ($sidebarUser->role ?? 'User')); ?></div>
                        <div class="small text-muted"><?php echo e($sidebarUser->email ?? ''); ?></div>
                    </div>
                </div>
            </li>
            ...
            <li>
                <a class="dropdown-item d-flex align-items-center gap-2" href="<?php echo e(route('profile.edit')); ?>#password">
...
</script><?php /**PATH C:\xampp\htdocs\POS\resources\views/layouts/AdminSidebar.blade.php ENDPATH**/ ?>