<aside class="sidebar shadow-sm p-4 d-flex flex-column justify-content-between" id="sidebar">
    ...
    <div class="grow" style="overflow-y: auto; overflow-x: hidden;">
        <nav class="d-flex flex-column gap-1" style="width: 100%; overflow: hidden;">
            <!-- Dashboard Section -->
            <a href="<?php echo e(route('cashier.dashboard')); ?>" class="<?php echo e(request()->routeIs('cashier.dashboard') ? 'd-flex align-items-center rounded-lg text-decoration-none active' : 'd-flex align-items-center rounded-lg text-decoration-none'); ?>">
            ...
            <a href="<?php echo e(route('cashier.products.index')); ?>" class="d-flex align-items-center rounded-lg text-decoration-none">
                <span class="bg-transparent rounded d-flex align-items-center justify-content-center icon-badge">
            ...
            <?php if (\Illuminate\Support\Facades\Blade::check('canAccess', 'product_category','edit')): ?>
            <a href="<?php echo e(route('cashier.categories.index')); ?>" class="d-flex align-items-center rounded-lg text-decoration-none">
                <span class="bg-transparent rounded d-flex align-items-center justify-content-center icon-badge">
            ...
            <?php if (\Illuminate\Support\Facades\Blade::check('canAccess', 'inventory','edit')): ?>
            <a href="<?php echo e(route('cashier.purchases.index')); ?>" class="d-flex align-items-center rounded-lg text-decoration-none">
                <span class="bg-transparent rounded d-flex align-items-center justify-content-center icon-badge">
            ...
            <a href="<?php echo e(route('cashier.stockin.index')); ?>" class="d-flex align-items-center rounded-lg text-decoration-none">
                <span class="bg-transparent rounded d-flex align-items-center justify-content-center icon-badge">
            ...
            <a href="<?php echo e(route('cashier.inventory.index')); ?>" class="d-flex align-items-center rounded-lg text-decoration-none">
                <span class="bg-transparent rounded d-flex align-items-center justify-content-center icon-badge">
                    <i class="fas fa-box sidebar-icon"></i>
                </span>
                <span>Inventory</span>
            ...
            <?php if (\Illuminate\Support\Facades\Blade::check('canAccess', 'stock_transfer','view')): ?>
            ...
            <a href="<?php echo e(route('cashier.sales.index')); ?>" class="d-flex align-items-center rounded-lg text-decoration-none">
                <span class="bg-transparent rounded d-flex align-items-center justify-content-center icon-badge">
            ...
            <?php if (\Illuminate\Support\Facades\Blade::check('canAccess', 'sales_report','view')): ?>
            <a href="<?php echo e(route('cashier.sales.reports')); ?>" class="d-flex align-items-center rounded-lg text-decoration-none">
                <span class="bg-transparent rounded d-flex align-items-center justify-content-center icon-badge">
            ...
            <?php if (\Illuminate\Support\Facades\Blade::check('canAccess', 'sales','edit')): ?>
            <a href="<?php echo e(route('cashier.refunds.index')); ?>" class="d-flex align-items-center rounded-lg text-decoration-none">
                <span class="bg-transparent rounded d-flex align-items-center justify-content-center icon-badge">
            ...
            <!-- Finance Section -->
            <?php if (\Illuminate\Support\Facades\Blade::check('canAccess', 'credit','view')): ?>
            <div class="section-label">FINANCE</div>
            
            <a href="<?php echo e(route('cashier.credit.index')); ?>" class="d-flex align-items-center rounded-lg text-decoration-none">
                <span class="bg-transparent rounded d-flex align-items-center justify-content-center icon-badge">
            ...
            <?php if (\Illuminate\Support\Facades\Blade::check('canAccess', 'expenses','view')): ?>
            <a href="<?php echo e(route('cashier.expenses.index')); ?>" class="d-flex align-items-center rounded-lg text-decoration-none">
                <span class="bg-transparent rounded d-flex align-items-center justify-content-center icon-badge">
            ...
            <!-- Customer Section -->
            <?php if (\Illuminate\Support\Facades\Blade::check('canAccess', 'customer','view')): ?>
            <div class="section-label">CUSTOMER</div>
            
            <a href="<?php echo e(route('cashier.customers.index')); ?>" class="d-flex align-items-center rounded-lg text-decoration-none">
                <span class="bg-transparent rounded d-flex align-items-center justify-content-center icon-badge">
    ...
    <div class="dropend">
        <button class="btn dropdown-toggle w-100 d-flex align-items-center gap-2" type="button" id="userDropdown" data-bs-toggle="dropdown" aria-expanded="false">
            ...
            <span class="sidebar-text"><?php echo e(Auth::user()->name ?? 'Cashier'); ?></span>
        </button>
        <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="userDropdown">
            <li><a class="dropdown-item" href="<?php echo e(route('profile.edit')); ?>">
                <i class="fas fa-user me-2"></i>Profile
            </a></li>
            <li><a class="dropdown-item" href="<?php echo e(route('profile.password')); ?>">
...
<?php /**PATH C:\xampp\htdocs\POS\resources\views/layouts/CashierSidebar.blade.php ENDPATH**/ ?>