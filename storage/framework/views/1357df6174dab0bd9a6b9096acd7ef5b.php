                        ...
                        <div class="products-header-card">
                            <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                                ...
                                <div class="d-flex align-items-center gap-2 flex-wrap">
                                    ...
                                    <a href="<?php echo e(route('superadmin.products.create')); ?>" class="btn btn-add-product d-flex align-items-center gap-2">
                                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                    ...
                                    <table class="table products-table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>
                                                    <a href="<?php echo e(route('superadmin.products.index', ['sort_by' => 'id', 'sort_direction' => ($sortBy == 'id' && $sortDirection == 'asc') ? 'desc' : 'asc'])); ?>">
                                                        ID
                                                        <?php if($sortBy == 'id'): ?>
                                        ...
                                        <tbody id="product-table-body">
                                            <?php echo $__env->make('SuperAdmin.products._product_table', ['products' => $products], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                        </tbody>
                                    </table>
                                </div>
                            </div>
    ...
    $(document).ready(function () {
        ...
        $('#product-search-input').on('keyup', function () {
            ...
            searchTimeout = setTimeout(function() {
                $.ajax({
                    url: "<?php echo e(route('superadmin.products.index')); ?>",
                    type: "GET",
                    data: { 'search': query },
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\POS\resources\views/SuperAdmin/products/productIndex.blade.php ENDPATH**/ ?>