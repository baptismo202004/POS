    ...
    <div class="card card-rounded shadow-sm">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex gap-2">
                <a href="<?php echo e(route('admin.credits.create')); ?>" class="btn btn-primary">
                ...
                <a href="<?php echo e(route('admin.sales.management.index')); ?>" class="btn btn-outline-primary">Go to Sales</a>
            </div>
        </div>
        <div class="card-body">
            <div class="row">
                        ...
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    ...
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">₱<?php echo e(number_format($todayCredits->total_credit_amount ?? 0, 2)); ?></div>
                                </div>
                                <div class="col-auto">
                        ...
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    ...
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">₱<?php echo e(number_format($todayCredits->total_outstanding ?? 0, 2)); ?></div>
                                </div>
                                <div class="col-auto">
                        ...
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    ...
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">₱<?php echo e(number_format($monthlyCredits->total_credit_amount ?? 0, 2)); ?></div>
                                </div>
                                <div class="col-auto">
                        ...
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    ...
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">₱<?php echo e(number_format($overdueCredits->total_overdue_amount ?? 0, 2)); ?></div>
                                </div>
                                <div class="col-auto">
                ...
                <table class="table table-bordered" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td><?php echo e($customer->branch_name ?? 'N/A'); ?></td>
                                <td><strong><?php echo e($customer->full_name); ?></strong></td>
                                <td>
                                    <span class="badge bg-<?php echo e($customer->credit_source == 'Sales' ? 'info' : 
                                        ($customer->credit_source == 'Cash' ? 'success' : 'secondary')); ?>">
                                        <?php echo e($customer->credit_source); ?>

                                    </span>
                                </td>
                                <td><?php echo e($customer->credit_giver_total); ?></td>
                                <td>₱<?php echo e(number_format($customer->total_credit, 2)); ?></td>
                                <td>₱<?php echo e(number_format($customer->total_paid, 2)); ?></td>
                                <td>₱<?php echo e(number_format($customer->outstanding_balance, 2)); ?></td>
                                <td><?php echo e(\Carbon\Carbon::parse($customer->last_credit_date)->format('M d, Y')); ?></td>
                                <td>
                                    <span class="badge bg-<?php echo e($customer->status == 'Fully Paid' ? 'success' : ($customer->status == 'Good Standing' ? 'warning' : 'danger')); ?>">
                                ...
                                <td>
                                    <div class="btn-group btn-group-sm">
                                        <button class="btn btn-outline-primary" onclick="viewCustomerCredits(<?php echo e($customer->customer_id); ?>)">
                                            <i class="fas fa-eye"></i> View Details
                                        </button>
                                        <?php if($customer->outstanding_balance > 0): ?>
                                            <button class="btn btn-outline-success" onclick="makeCustomerPayment(<?php echo e($customer->customer_id); ?>, <?php echo e($customer->outstanding_balance); ?>)">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\POS\resources\views/Admin/credits/index.blade.php ENDPATH**/ ?>