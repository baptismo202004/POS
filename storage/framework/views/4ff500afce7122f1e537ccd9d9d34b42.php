<?php $__env->startSection('title', 'Add Stock In'); ?>
...
<?php $__env->startPush('stylesDashboard'); ?>
    ...
    <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11?v=<?php echo e(rand(1000, 9999)); ?>"></script>
    <style>
    ...
    <div class="row mb-6">
        <div class="col-12">
            <div class="p-4 card-rounded shadow-sm bg-white">
                ...
                <form action="<?php echo e(route('admin.stockin.store')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="purchase_id" id="purchase_id" class="form-select" required>
                                            ...
                                            <?php $__currentLoopData = $purchases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $purchase): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($purchase->id); ?>">
                                                    <?php echo e($purchase->supplier_name ?? 'N/A'); ?>

                                                    | <?php echo e($purchase->reference_number ?: 'N/A'); ?>

                                                    | <?php echo e($purchase->purchase_date ? \Carbon\Carbon::parse($purchase->purchase_date)->format('m/d/Y') : 'N/A'); ?>

                                                    | <?php echo e($purchase->remaining_quantity); ?> stocks remaining
                                                </option>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        if (purchaseSelect) {
            purchaseSelect.addEventListener('change', async function () {
                ...
                try {
                    var res = await fetch('<?php echo e(url('admin/stockin/products-by-purchase')); ?>/' + purchaseId, {
                    ...
                    if (data.items && data.items.length > 0) {
                        ...
                        var branchOptions = <?php echo json_encode($branches ? $branches->map(function($branch) {
        ...
        if (form) {
            form.addEventListener('submit', async function(e) {
                ...
                try {
                    var response = await fetch('<?php echo e(route('admin.stockin.store')); ?>', {
                        method: 'POST',
                        body: formData
                    });
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\POS\resources\views/Admin/stockin/create.blade.php ENDPATH**/ ?>