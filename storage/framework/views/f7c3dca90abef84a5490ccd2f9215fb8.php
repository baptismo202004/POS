<?php $__env->startSection('title', 'Credit Management'); ?>
    ...
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div class="d-flex gap-2">
                <?php if (\Illuminate\Support\Facades\Blade::check('canAccess', 'credit_limits','view')): ?>
                <button class="btn btn-info" onclick="showCreditLimits()">
                    <i class="fas fa-chart-bar me-2"></i>Credit Limits
                </button>
                <?php endif; ?>
                <a href="<?php echo e(route('cashier.credit.create')); ?>" class="btn btn-primary">
        ...
        <div class="row mb-4">
            <div class="col-md-4">
                <div class="stats-card">
                    <div class="stats-number"><?php echo e($credits->total()); ?></div>
                    <div class="stats-label">Total Credits</div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="stats-card">
                    <div class="stats-number"><?php echo e($credits->where('status', 'pending')->count()); ?></div>
                    <div class="stats-label">Pending Credits</div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="stats-card">
                    <div class="stats-number">₱<?php echo e(number_format($credits->where('status', 'pending')->sum('amount'), 2)); ?></div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <strong><?php echo e($credit->customer_name ?? 'N/A'); ?></strong>
                                                <br>
                                                <small class="text-muted"><?php echo e($credit->customer_email ?? 'N/A'); ?></small>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="fw-bold">₱<?php echo e(number_format($credit->amount, 2)); ?></td>
                                    <td><?php echo e(\Carbon\Carbon::parse($credit->due_date)->format('M d, Y')); ?></td>
                                    <td>
                                        <span class="status-badge status-<?php echo e($credit->status); ?>">
                                            <?php echo e($credit->status); ?>

                                        </span>
                                    </td>
                                    <td><?php echo e(\Carbon\Carbon::parse($credit->created_at)->format('M d, Y')); ?></td>
                                    <td>
                                        <div class="btn-group btn-group-sm">
                                            <a href="<?php echo e(route('cashier.credit.edit', $credit->id)); ?>" class="btn btn-sm btn-outline-primary">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <form action="<?php echo e(route('cashier.credit.destroy', $credit->id)); ?>" method="POST" class="d-inline">
                                                <?php echo csrf_field(); ?>
            ...
            <?php if($credits->hasPages()): ?>
                <div class="card-footer bg-light">
                    <div class="d-flex justify-content-between align-items-center">
                        <span class="text-muted">Showing <?php echo e($credits->firstItem()); ?> to <?php echo e($credits->lastItem()); ?> of <?php echo e($credits->total()); ?> credits</span>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\POS\resources\views/cashier/credit/index.blade.php ENDPATH**/ ?>