...
<body>
    ...
    <div class="main-container">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div>
                <a href="<?php echo e(route('admin.sales.management.index')); ?>" class="btn btn-outline-primary">
    ...
    (function(){
        ...
        async function search(mode='list'){
            ...
            const url = "<?php echo e(route('pos.lookup')); ?>";
...
<?php /**PATH C:\xampp\htdocs\POS\resources\views/Admin/pos/index.blade.php ENDPATH**/ ?>