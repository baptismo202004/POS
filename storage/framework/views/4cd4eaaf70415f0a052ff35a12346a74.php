                    ...
                    <div class="p-4 card-rounded shadow-sm bg-white">
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <div>
                                ...
                                <p class="mb-0 text-muted">
                                    <?php if(isset($selectedDate)): ?>
                                        ...
                                        <a href="<?php echo e(route('admin.sales.management.index')); ?>" class="text-primary text-decoration-none">
                            ...
                            <div class="d-flex gap-2">
                                <a href="<?php echo e(route('pos.index')); ?>" class="btn btn-primary">Go to POS</a>
                            </div>
                        </div>
                                        ...
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                    <?php echo e(isset($selectedDate) ? $selectedDate->format('M d, Y') : 'Today\'s Sales'); ?>
                                    ...
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                ...
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">₱<?php echo e(number_format($allBranchesTodaySales->total_revenue ?? 0, 2)); ?></div>
                                            </div>
                                            <div class="col-auto">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group">
                                                <button class="btn btn-sm btn-info" onclick="showSaleDetails(<?php echo e($sale->id); ?>)" title="View Details">
                                                    <i class="fas fa-eye"></i>
                                                </button>
                                                <button class="btn btn-sm btn-secondary" onclick="showSaleHistory(<?php echo e($sale->id); ?>)" title="View History">
                                                    <i class="fas fa-history"></i>
                                                </button>
                                                <button class="btn btn-sm btn-danger" onclick="showDeleteSale(<?php echo e($sale->id); ?>)" title="Delete Sale">
...
function filterSalesByDate() {
    ...
    if (selectedDate) {
        window.location.href = `<?php echo e(route('admin.sales.management.index')); ?>?date=${selectedDate}`;
    } else {
        window.location.href = '<?php echo e(route('admin.sales.management.index')); ?>';
    }
}
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\POS\resources\views/Admin/sales/management.blade.php ENDPATH**/ ?>