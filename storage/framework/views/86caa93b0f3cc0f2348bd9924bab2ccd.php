...
<div class="container-fluid">
    <div class="p-4 card-rounded shadow-sm bg-white">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a href="<?php echo e(route('admin.expenses.index')); ?>" class="btn btn-light border">Back to Expenses</a>
        </div>
        <div class="card-body">
                ...
                <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="date" class="form-control" name="expense_date" id="expense_date" value="<?php echo e(now()->format('Y-m-d')); ?>" required>
                                    </div>
                                    <div class="mb-3">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\POS\resources\views/Admin/expenses/create.blade.php ENDPATH**/ ?>