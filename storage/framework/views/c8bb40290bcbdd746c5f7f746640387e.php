                ...
                <div class="row mb-6">
                    <div class="col-12">
                        <div class="p-4 card-rounded shadow-sm bg-white">
                            ...
                            <form method="POST" action="<?php echo e(route('cashier.purchases.store')); ?>">
                                <?php echo csrf_field(); ?>

                                <div class="row g-3 mb-4">
                                    <div class="col-md-4">
                                        <label class="form-label">Purchase Date</label>
                                        <input type="date" name="purchase_date" class="form-control" required value="<?php echo e(date('Y-m-d')); ?>">
                                    </div>
                                    <div class="col-md-4">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="addSupplierForm" action="<?php echo e(route('cashier.suppliers.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="mb-3">
        ...
        if (sidebar) {
            ...
            if (logoImg) {
                logoImg.addEventListener('click', () => {
                    window.location.href = '<?php echo e(route('cashier.dashboard')); ?>';
                });
            }
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\POS\resources\views/cashier/purchase/create.blade.php ENDPATH**/ ?>