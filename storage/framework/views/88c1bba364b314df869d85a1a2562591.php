...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            ...
            <div class="card mb-4">
                <div class="card-body">
                    <form method="GET" action="<?php echo e(route('superadmin.sales.voided')); ?>">
                ...
                <div class="col-md-6">
                    <div class="card border-danger">
                        <div class="card-body text-center">
                            ...
                            <h2 class="mb-0">₱<?php echo e(number_format($totalVoidedAmount, 2)); ?></h2>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="card border-warning">
                        <div class="card-body text-center">
                            ...
                            <h2 class="mb-0"><?php echo e($totalVoidedCount); ?></h2>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <?php if($voidedSales->count() > 0): ?>
                        <div class="table-responsive">
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                    <?php $__currentLoopData = $voidedSales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                ?>
                                                <?php echo e($display ?: 'No products'); ?>

                                            </td>
                                            <td><?php echo e($sale->cashier ? $sale->cashier->name : 'N/A'); ?></td>
                                            <td><?php echo e($sale->branch ? $sale->branch->branch_name : 'N/A'); ?></td>
                                            <td><?php echo e($sale->saleItems->sum('quantity')); ?></td>
                                            <td><?php echo e($sale->original_items_count ?? 0); ?></td>
                                            <td class="text-danger fw-bold">₱<?php echo e(number_format($sale->total_amount, 2)); ?></td>
                                            <td>
                                                <span class="badge bg-secondary"><?php echo e(ucfirst($sale->payment_method)); ?></span>
                                            </td>
                                            <td>
                                                <a href="<?php echo e(route('superadmin.sales.receipt', $sale->id)); ?>" 
                                ...
                                <tfoot>
                                    <tr class="table-danger">
                                        ...
                                        <th class="text-danger fw-bold">₱<?php echo e(number_format($totalVoidedAmount, 2)); ?></th>
                                        <th colspan="2"><?php echo e($totalVoidedCount); ?> Sales</th>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-3">
                            <div>
                                Showing <?php echo e($voidedSales->firstItem()); ?> to <?php echo e($voidedSales->lastItem()); ?> 
                                of <?php echo e($voidedSales->total()); ?> entries
                            </div>
                            <?php echo e($voidedSales->links()); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\POS\resources\views/Admin/sales/voided.blade.php ENDPATH**/ ?>