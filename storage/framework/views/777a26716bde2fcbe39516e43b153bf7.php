                            ...
                            <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
                                ...
                                <div class="d-flex align-items-center gap-2 flex-wrap">
                                    <div class="search-wrapper">
                                        ...
                                        <input type="text" name="search" id="category-search-input" class="form-control" placeholder="Search categories..." value="<?php echo e(request('search')); ?>">
                                    </div>
...
<div class="modal fade" id="categoryModal" tabindex="-1" aria-labelledby="categoryModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="categoryForm" action="<?php echo e(route('cashier.categories.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="mb-3">
...
<script>
                ...
                Swal.fire({
                    ...
                    preConfirm: () => {
                        ...
                        return new Promise((resolve, reject) => {
                            ...
                            // Send AJAX request
                            fetch('<?php echo e(route("cashier.categories.deleteMultiple.post")); ?>', {
                                method: 'POST',
                                body: formData,
                                headers: {
    ...
    function openCategoryModal() {
        document.getElementById('categoryForm').action = '<?php echo e(route("cashier.categories.store")); ?>';
    ...
    document.getElementById('categoryForm')?.addEventListener('submit', function(e) {
        ...
        fetch('<?php echo e(route("cashier.categories.store")); ?>', {
            method: 'POST',
            headers: {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\POS\resources\views/cashier/categories/index.blade.php ENDPATH**/ ?>