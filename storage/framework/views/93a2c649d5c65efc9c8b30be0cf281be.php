            ...
            <div class="col-lg-8">
                <div class="card form-card">
                    ...
                    <div class="card-body p-4">
                        ...
                        <form action="<?php echo e(route('cashier.expenses.store')); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="row">
                            ...
                            <div class="d-flex gap-2">
                                ...
                                <a href="<?php echo e(route('cashier.expenses.index')); ?>" class="btn btn-outline-secondary">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\POS\resources\views/cashier/expenses/create.blade.php ENDPATH**/ ?>